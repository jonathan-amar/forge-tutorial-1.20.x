package net.jonathanamar.tutorialmod.block;

import net.jonathanamar.tutorialmod.TutorialMod;
import net.jonathanamar.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SAPPHIRE_DOOR = registerBlock("sapphire_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().sound(SoundType.AMETHYST),
                   BlockSetType.IRON ));
    public static final RegistryObject<Block> SAPPHIRE_TRAPDOOR = registerBlock("sapphire_trapdoor",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().sound(SoundType.AMETHYST),
                    BlockSetType.IRON));
